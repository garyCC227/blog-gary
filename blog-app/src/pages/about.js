        ...
        <div class={`row ${styles["my-row"]}`}>
          ...
          <div class=' eleven wide column'>
            ...
            <p className={styles.desc}>
              Honours thesis in partial domain adaptation and image
              classification research, HD grade. Act as full stack developer in
              many software projects, including web front-end with React and
              Flask, API design + development with Python and Java. C and C++
          ...
          <div class=' eleven wide column'>
            ...
            <section className=''>
              <h4 className='ui header'>
                Web development
                <div className={`sub header ${styles["sub-header"]}`}>
                  ReactJs, Redux, React-native, Node.js, Javascript, Flask,
                  HTML, CSS, Boostrap
                </div>
                <br />
              </h4>
          ...
          <div class=' eleven wide column'>
            ...
            <section className=''>
              <h4 className='ui header'>
                ...
                <div className={`sub header ${styles["sub-header"]}`}>
                  <a
                    href='https://garycc227.github.io/blog-gary'
                    target='_blank'
                  >
                    Personal Blog
                  </a>
