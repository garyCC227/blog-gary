    ...
    <div class={`ui grid ${styles["my-section"]}`}>
        ...
        <div class={`row ${styles["my-row"]}`}>
          <div className='five wide column'>
            <div className={`ui two item menu ${styles.box}`}>
              <div className='item'>
                <AiOutlineFire className={styles["box-icon"]} style={{color:'rgb(235, 163, 163)'}} />
              </div>
              <div className='item'>
                <h5 className='ui header'>
                  10
                  <div className='sub header'>Project Completed</div>
                </h5>
              </div>
            </div>
          </div>
          ...
          <div className='five wide column'>
            <div className={`ui two item menu ${styles.box}`}>
              <div className='item'>
                <GiCoffeeCup className={styles["box-icon"]} style={{color:'rgb(131, 131, 240)'}}/>
              </div>
              <div className='item'>
                <h5 className='ui header'>
                  10
                  <div className='sub header'>Cup of milktea</div>
                </h5>
              </div>
            </div>
          </div>
          ...
          <div className='five wide column'>
            <div className={`ui two item menu ${styles.box}`}>
              <div className='item'>
                <FaCity className={styles["box-icon"]} style={{color: 'rgb(207, 235, 163)'}} />
              </div>
              <div className='item'>
                <h5 className='ui header'>
                  10
                  <div className='sub header'>Visited Cities</div>
                </h5>
              </div>
            </div>
          </div>
